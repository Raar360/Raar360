...
export function Button({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "inline-flex items-center justify-center font-semibold outline-none transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-cream disabled:opacity-50",
        variants[variant],
        sizes[size],
        className,
      )}
